#親インスタンス= Category.create(name:'哺乳類') 　　　
#子インスタンス= 親インスタンス.children.create(name:'人類') 　
#孫インスタンス= 子インスタンス.children.create(name:'木下さん') 
#孫インスタンス= 子インスタンス.children.create(name:'ヨネさん') 
#孫インスタンス= 子インスタンス.children.create(name:'はらちゃん') 
#孫インスタンス= 子インスタンス.children.create(name:'さとるくん') 
#孫インスタンス= 子インスタンス.children.create(name:'土田') 
#①まず大元となる親インスタンスを作る
#②その親インスタンスの下に位置する子インスタンスを作る　childrenメソッドで作ることができる
#③あとは増やしたいだけ子インスタンスを作る
#これで哺乳類→人類→我々、のモデルケースが作れる
